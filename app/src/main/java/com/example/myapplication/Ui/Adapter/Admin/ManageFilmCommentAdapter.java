...
public class ManageFilmCommentAdapter extends RecyclerView.Adapter<ManageFilmCommentAdapter.ViewHolder> {
    ...
    public ManageFilmCommentAdapter(List<Film> list, Fragment fragment) {
        this.list = list;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onBind(Film f, int pos){
            ...
            txtViewSaved.setText(f.getFilm_views() + " comments");
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(fragment.getActivity(), ManageCommentActivity.class);
